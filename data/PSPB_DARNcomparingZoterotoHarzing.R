...
harzinglist <- read.csv("/Users/SchoolAccount/Documents/GitHub/darn-textscan/data/PSPB_deduplicated.csv")
zoterolist <- read.csv("/Users/SchoolAccount/Documents/GitHub/darn-textscan/data/PSPB _DARN_ZoteroExport.csv")
...
write.csv(unknownarticles, "pspb_harzingnotzotero.csv")
